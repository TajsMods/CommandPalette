class_name TajsCommandPaletteHelpMode
...
func _create_entry_row(item: Dictionary, _index: int) -> Control:
    var row = PanelContainer.new()
...
func _create_detail_row(item: Dictionary, _index: int) -> Control:
    var row = PanelContainer.new()
